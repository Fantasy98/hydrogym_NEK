...
<<<<<<< HEAD
    ...
    def _open_files(self):
        ...
        if self.episode_writer is None:
            ...
            # Write header
            header = ['timestamp', 'episode', 'total_steps', 'mean_reward', 'std_reward',
...
<<<<<<< HEAD
        ...
        # Log episode summary
        row = [current_time, episode, total_steps, mean_reward, std_reward,
               min_reward, max_reward, total_reward, duration]
...
<<<<<<< HEAD
    ...
    def log_reward(self, agent_name: str, reward: float, dUdy_raw: float = 0.0, 
